    ...
    <div class="container mx-auto p-4">
        ...
        <div>
            <button v-for="(country, key) in country_data"
                    class="py-2 px-4 rounded border-4 m-1 focus:outline-none"
                ...
                <span v-if="check_answers">
                    <template v-if="word.selected === word.status">
                        <span v-if="word.status === 'real'">
                            ...
                            {{word.word}} is a <a target="_blank" :href="`https://www.google.com/search?q=${word.word}`" class="underline">real pace in {{selected_country.name}}</a>.
                        </span>
                        <span v-else>
                            <span class="bg-green-300 py-2 px-4 rounded">Correct!</span>
